...
public class Helper {
    public static Object helper(String string){
        ...
        final Matcher matcher=EMAIL_PATTERN.matcher(string);
        boolean foundString=matcher.matches();
        if(foundString&&string!=null&&string.length()!=0){
